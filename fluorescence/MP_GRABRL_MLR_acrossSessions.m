...
for ii = 1:nFiles
    ...
    % load behavior files
     ...
     saveRegName = fullfile(savematpath,'regRL_norm.mat');  % regression for fluo change
...
print(gcf,'-dpng','MLR-norm_choiceselection_averageSession');    %png format
saveas(gcf, 'MLR-norm_choiceselection_averageSession', 'fig');
saveas(gcf, 'MLR-norm_choiceselection_averageSession','svg');
...
print(gcf,'-dpng','MLR-norm_choiceselection_sigSession');    %png format
saveas(gcf, 'MLR-norm_choiceselection_sigSession', 'fig');
