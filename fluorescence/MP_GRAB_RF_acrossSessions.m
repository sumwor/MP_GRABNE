...
rf_cr_all.coeff= all_predImp(:,1:8,:);
...
rf_cr_all.regr_time = reg_all.regr_time;
rf_cr_all.numPredictor = size(rf_cr_all.coeff,2);
rf_cr_all.interaction = 0;
rf_cr_all.pvalThresh= 0.01;
