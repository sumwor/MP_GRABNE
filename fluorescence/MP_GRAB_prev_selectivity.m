function MP_GRAB_prev_selectivity(dataIndex);

% calculate choice and reward (from previous trial) selectivity
...
for ii = 1:nFiles
    ...
    if length(fn_fluo) == 1
        ...
        saveSelName = fullfile(savematpath,'prev_select_norm.mat');  % random forest
        ...
        if ~exist(saveSelName)
            ...
            fieldname1={'left'}; trialMask1 = getMask_prev(trials,fieldname1);
            fieldname2={'right'}; trialMask2 = getMask_prev(trials,fieldname2);
            fieldname3={'reward'}; trialMask3 = getMask_prev(trials,fieldname3);
             fieldname4={'noreward'}; trialMask4 = getMask_prev(trials,fieldname4);
             tic
